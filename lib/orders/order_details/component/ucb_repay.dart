...
class UcbRepay extends StatefulWidget {
  String? orderId;

  UcbRepay({required this.orderId});

  @override
  State<UcbRepay> createState() => _UcbRepayState();
}

class _UcbRepayState extends State<UcbRepay> {
  ...
  Future<int> getBkashInitials({required String? orderId}) async {
    ...
    try {
      var url = Uri.parse(AppUrl.base_url +
          "/ucb/begin?payment_type=single_order_payment&order_id=$orderId");
      print(url);
