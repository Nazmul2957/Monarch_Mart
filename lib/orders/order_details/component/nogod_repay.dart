...
class NogodRepay extends StatefulWidget {
  String? orderId;

  NogodRepay({required this.orderId});

  @override
  State<NogodRepay> createState() => _NogodRepayState();
}

class _NogodRepayState extends State<NogodRepay> {
  ...
  void initState() {
    super.initState();
    getNagadInitials(orderId: widget.orderId);
  }
  ...
  Future<int> getNagadInitials({required String? orderId}) async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    try {
      var url = Uri.parse(AppUrl.base_url +
          "/nagad/begin?payment_type=single_order_payment&order_id=$orderId");
      print(url);
