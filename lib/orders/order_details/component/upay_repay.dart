...
class UpayRepay extends StatefulWidget {
  String? orderId;

  UpayRepay({required this.orderId});

  @override
  State<UpayRepay> createState() => _UpayRepayState();
}

class _UpayRepayState extends State<UpayRepay> {
  ...
  Future<int> getBkashInitials({required String? orderId}) async {
    ...
    try {
      var url = Uri.parse(AppUrl.base_url +
          "/upay/begin?payment_type=single_order_payment&order_id=$orderId");
      print(url);
